...
Shared Ember.js core utilities, services, models, adapters, serializers, runtime configuration, and reusable frontend infrastructure.

## Allowed Work

- Bug fixes and small enhancements to shared Ember services, adapters, serializers, models, utilities, and runtime configuration.
- Tests, documentation, compatibility fixes, and frontend infrastructure improvements that preserve existing public behavior.
- Shared API-client changes when downstream and documentation impact are evaluated.

## Restricted Work

- Breaking shared API, model, adapter, serializer, or runtime configuration changes without explicit review.
- Large cross-package refactors without approval.
- Changes that affect documented developer workflows without checking `fleetbase/fleetbase.io`.
